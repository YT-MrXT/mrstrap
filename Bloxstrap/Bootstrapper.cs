...
namespace Bloxstrap
{
    public class Bootstrapper
    {
        ...
        #region App Install
        private Task<bool> CheckForUpdates()
        {
            const string LOG_IDENT = "Bootstrapper::CheckForUpdates";

            // Auto-update disabled: this build does not publish its own releases,
            // so checking for updates would download and install the original upstream build.
            App.Logger.WriteLine(LOG_IDENT, "Auto-update is disabled for this build");
